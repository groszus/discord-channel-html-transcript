...
import dev.omardiaa.transcript.api.model.payload.message.Attachment;
import dev.omardiaa.transcript.api.model.payload.message.Embed;
import dev.omardiaa.transcript.api.model.payload.message.InteractionType;
import dev.omardiaa.transcript.api.model.payload.message.User;
import dev.omardiaa.transcript.api.model.payload.message.component.Component;
