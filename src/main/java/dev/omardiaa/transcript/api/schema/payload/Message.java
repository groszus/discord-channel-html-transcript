...
import dev.omardiaa.transcript.api.schema.payload.message.Attachment;
import dev.omardiaa.transcript.api.schema.payload.message.Embed;
import dev.omardiaa.transcript.api.schema.payload.message.InteractionType;
import dev.omardiaa.transcript.api.schema.payload.message.component.Component;
import dev.omardiaa.transcript.api.schema.payload.util.Emoji;
import dev.omardiaa.transcript.api.util.TimeUtil;
